...
class ForgotPage extends React.Component {
  ...
  renderSendButton() {
    ...
    return (
      <TouchableOpacity style={style.newPass}>
        <Text style={style.newPassTxt}>Şifremi Sıfırla</Text>
      </TouchableOpacity>
    );
  }
  render() {
    ...
    return (
      <View
        ...
        />
        <Text style={style.forgotPassTxt}>Şifreni mi Unuttun?</Text>
        <Text style={style.enterEmailTxt}>Emailini gir.</Text>
...
export default connect(mapStateProps, {forgot_mail_changed, forgot_mail})(
  ForgotPage,
);
